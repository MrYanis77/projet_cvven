...
<title>CVVEN INSCRIPTION ADMIN</title>
<link rel="stylesheet" href="<?= base_url('css/form.css'); ?>"> 
</head>
<body>
<div class="register-form ">
    <form action="<?= base_url('index.php/PageAdmin/addadmin/enregistrement');?>" method="post">
        <h2 class="text-center">Inscription Admin</h2>
